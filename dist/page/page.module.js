...
PageModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: page_entity_1.Page.name, schema: page_entity_1.PageSchema }]),
        ],
        controllers: [page_controller_1.PageController, page_controller_1.PublicPageController],
